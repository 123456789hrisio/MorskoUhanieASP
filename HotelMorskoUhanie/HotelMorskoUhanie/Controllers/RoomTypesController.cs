...
namespace HotelMorskoUhanie.Controllers
{
    public class RoomTypesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Name,DateModified")] RoomType roomType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,DateModified")] RoomType roomType)
        {
            if (id != roomType.Id)
            {
                return NotFound();
